...
public class controllerTrash implements Initializable {
	  ...
	  static App apps ;
	@FXML 
	private TableView<person> tableT;
	@FXML 
	...
	tableT.setOnMouseClicked(e -> {
	  if(!tableT.getItems().isEmpty()) {
		show();
	  }
	});
        tableT.setItems(received);
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public ObservableList<person> getData(){
		apps.folder = new Folder("Accounts\\"+apps.accountUser+"\\Trash");
	...
	public void deleteSelected(ActionEvent event ) {
		...
		for(int i=0;i<list.size();i++) {
			if(list.get(i).getAction().isSelected()) {	
				...
				EmailOperations.removeEmail(apps.folder.index, m);
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	public void show() {
		...
		try {
			...
			int number = tableT.getSelectionModel().getSelectedIndex();
