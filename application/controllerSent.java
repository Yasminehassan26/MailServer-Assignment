...
public class controllerSent implements Initializable {
	...
	@FXML 
	private TableView<person> tableS;
	@FXML 
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public ObservableList<person> getData(){
		apps.folder = new Folder("Accounts\\"+apps.accountUser+"\\Sent");
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	public void show() {
		...
		try {
			...
			int number = tableS.getSelectionModel().getSelectedIndex();
...
public void inbox (ActionEvent event ) {
	FXMLLoader loader=new FXMLLoader(getClass().getResource("/application/sent.fxml"));
	controllerSent.receive(apps);
	scenes test=new scenes();
	test.sent(event);
	}
