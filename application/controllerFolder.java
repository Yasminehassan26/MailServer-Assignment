...
public class controllerFolder implements Initializable {
  ...
  static App apps;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		labelFolder.setText(apps.extraFolderName);
		userLabel.setText(apps.accountUser);
	...
	if(file.exists()) {
		...
		for(int i =0;i<folders.size();i++) {
			...
			if(!((String)folders.get(i)).equals(apps.extraFolderName)) {
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public ObservableList<person> getData(){
		apps.folder = new Folder("Accounts\\"+apps.accountUser+"\\"+apps.extraFolderName);
		list = FXCollections.observableArrayList();
		Sort s = new Sort();
		s.setTypeOfSort(apps.sorting);
		Filter f = new Filter(apps.filtering);
		apps.setViewingOptions(apps.folder, f, s);
	...
	public void deleteSelected(ActionEvent event ) {
		apps.folder = new Folder("Accounts\\"+apps.accountUser+"\\"+NameFolder);
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	public void show() {
		...
		try {
			FXMLLoader loader=new FXMLLoader(getClass().getResource("/application/showMessage.fxml"));
			int number = table.getSelectionModel().getSelectedIndex();
			int indexOfMail = ((apps.pageNumber*10)-10)+number;
			Mail m = (Mail) apps.filteredList.get(indexOfMail);
			root=loader.load();
		    showEmail c=loader.getController();
            c.identify(m);		
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void folder (ActionEvent event ) {
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/application/folder.fxml"));
		Parent root;
		try {
			root = loader.load();
			...
			scenes test=new scenes();
			test.folder(event, root,NameFolder);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
